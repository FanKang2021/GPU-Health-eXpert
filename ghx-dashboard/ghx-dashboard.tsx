...
const i18n = {
  zh: {
    ...
    bandwidthTestDesc: "测试GPU内存带宽性能，评估数据传输效率",
  ...
  en: {
    ...
    bandwidthTestDesc: "Test GPU memory bandwidth performance, evaluate data transfer efficiency",
